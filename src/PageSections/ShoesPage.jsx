...
export default function ShoesPage() {
  ...
  const [newItems] = useState(FindShoesItems); // Using FindNewItems directly
  ...
  return (
    <div className="new-page">
      <PageMaker title="Shoes" productArray={sliceArray(newItems, endIndex)} />
      <LoadMoreBTN
...
function FindShoesItems() {
  let items = [];
  for (let i = 0; i < AllProducts.Products.length; i++) {
    if (AllProducts.Products[i].genre == "Shoe") {
